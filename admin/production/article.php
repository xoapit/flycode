    ...
    <div class="container body">
      <div class="main_container">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-newspaper-o"></i> Article</a>                   
                  </li>
                   <li><a href="#"><i class="fa fa-pencil"></i> Comments</a>                   
                  </li>
                   <li><a href="#"><i class="fa fa-user"></i> Commenters</a>                   
                  </li>
		...
		<div class="container" style="background:#eee;">
        	...
        	<div class="col-md-10 col-xs-12">
            	...
            	<div class="box-white table-responsive">
                	...
                	<table class="table table-striped table-responsive">
                        ...
                        <tbody>
                          <?php
                        	  $query= query($conn,"select * from baiviet");
            ...
            <div class="row">
            	<div class="col-md-8 box-white table-responsive col-md-offset-1">
                	<div class="text-bold"> Comments
                	...
                	<table class="table table-responsive">
                	  <thead>
                	    <th>ID</th>
                	    <th>Commentator</th>
                	    <th style="width:15%">ID Article</th>
                      ...
                      <tbody>
                           <?php
                        	  $query= query($conn,"select * from comment");
                        	  while($row=mysqli_fetch_assoc($query)){
                        	?>
                        	<tr>
